...
var INITIAL_MEMORY = Module["INITIAL_MEMORY"] || 196870144;
var wasmTable;
var __ATPRERUN__ = [];
var __ATINIT__ = [];
var __ATMAIN__ = [];
...
var wasmBinaryFile;
wasmBinaryFile = "pewpewlive.wasm";
...
var ASM_CONSTS = {
  ...
  1466326: function ($0, $1, $2) {
    var sound_id = $0;
    var sample_ptr = $1;
    var sample_count = $2;
    audio_buffer = Module.audioContext.createBuffer(
      1,
      sample_count,
      Module.audioContext.sampleRate
    );
    float_array = HEAPF32.subarray(
      sample_ptr / 4,
      sample_ptr / 4 + sample_count
    );
    if (typeof audio_buffer.copyToChannel == "function") {
      audio_buffer.copyToChannel(float_array, 0);
    } else {
      audio_buffer.getChannelData(0).set(float_array);
    }
    Module.audioBuffers[sound_id] = audio_buffer;
  },
  1466778: function ($0, $1, $2) {
    var sound_id = $0;
    Module.audioContext.resume().then(function () {
      var source = Module.audioContext.createBufferSource();
      var panner = Module.audioContext.createPanner();
      source.buffer = Module.audioBuffers[sound_id];
      if (panner.positionX) {
        panner.positionX.value = $1;
        panner.positionY.value = $2;
      } else {
        panner.setPosition($1, $2, 0);
      }
      panner.rolloffFactor = 0.1;
      source.connect(panner);
      panner.connect(Module.audioContext.destination);
      source.start(0);
    });
  },
  1467245: function ($0) {
  ...
  1467487: function ($0, $1) {
    var listener = Module.audioContext.listener;
  ...
  //modified
  1467736: function ($0, $1, $2, $3, $4, $5) {
    Module.urlRequestOnSuccess($1, $2, file);
  },
  1468345: function () {
...
var asmLibraryArg = {
  ...
  pe: _emscripten_glBindAttribLocation,
  oe: _emscripten_glBindBuffer,
  ne: _emscripten_glBindFramebuffer,
  me: _emscripten_glBindRenderbuffer,
  le: _emscripten_glBindTexture,
  ze: _emscripten_glBindVertexArrayOES,
  ke: _emscripten_glBlendColor,
  je: _emscripten_glBlendEquation,
  ie: _emscripten_glBlendEquationSeparate,
  he: _emscripten_glBlendFunc,
  ge: _emscripten_glBlendFuncSeparate,
  fe: _emscripten_glBufferData,
  ee: _emscripten_glBufferSubData,
  de: _emscripten_glCheckFramebufferStatus,
  ce: _emscripten_glClear,
  be: _emscripten_glClearColor,
  ae: _emscripten_glClearDepthf,
  $d: _emscripten_glClearStencil,
  _d: _emscripten_glColorMask,
  ...
  zd: _emscripten_glFramebufferRenderbuffer,
  yd: _emscripten_glFramebufferTexture2D,
  ...
  gd: _emscripten_glGetProgramInfoLog,
  hd: _emscripten_glGetProgramiv,
  ...
  fd: _emscripten_glGetRenderbufferParameteriv,
  ...
  ad: _emscripten_glGetString,
  $c: _emscripten_glGetTexParameterfv,
  _c: _emscripten_glGetTexParameteriv,
  ...
  fc: _emscripten_glUniform3f,
  ec: _emscripten_glUniform3fv,
  dc: _emscripten_glUniform3i,
  cc: _emscripten_glUniform3iv,
  ...
  wb: _glCreateShader,
  x: _glDeleteBuffers,
  Nb: _glDeleteFramebuffers,
  kb: _glDeleteProgram,
  qb: _glDeleteShader,
  I: _glDeleteTextures,
  Y: _glDetachShader,
  Ya: _glDisable,
  d: _glDisableVertexAttribArray,
  n: _glDrawElements,
  $a: _glEnable,
  e: _glEnableVertexAttribArray,
  ga: _glFramebufferTexture2D,
  k: _glGenBuffers,
  gc: _glGenFramebuffers,
  ia: _glGenTextures,
  De: _glGetIntegerv,
  mb: _glGetProgramInfoLog,
  Z: _glGetProgramiv,
...
var _malloc = (Module["_malloc"] = function () {
  return (_malloc = Module["_malloc"] = Module["asm"]["Ue"]).apply(
    null,
    arguments
  );
});
var _free = (Module["_free"] = function () {
  return (_free = Module["_free"] = Module["asm"]["Ve"]).apply(null, arguments);
});
...
var _fflush = (Module["_fflush"] = function () {
  return (_fflush = Module["_fflush"] = Module["asm"]["Xe"]).apply(
    null,
    arguments
  );
});
...
var _htonl = (Module["_htonl"] = function () {
  return (_htonl = Module["_htonl"] = Module["asm"]["Ze"]).apply(
    null,
    arguments
  );
});
var _htons = (Module["_htons"] = function () {
  return (_htons = Module["_htons"] = Module["asm"]["_e"]).apply(
    null,
    arguments
  );
});
var _ntohs = (Module["_ntohs"] = function () {
  return (_ntohs = Module["_ntohs"] = Module["asm"]["$e"]).apply(
    null,
    arguments
  );
});
...
var __get_tzname = (Module["__get_tzname"] = function () {
  return (__get_tzname = Module["__get_tzname"] = Module["asm"]["cf"]).apply(
    null,
    arguments
  );
});
...
var _setThrew = (Module["_setThrew"] = function () {
  return (_setThrew = Module["_setThrew"] = Module["asm"]["ff"]).apply(
    null,
    arguments
  );
});
var stackSave = (Module["stackSave"] = function () {
  return (stackSave = Module["stackSave"] = Module["asm"]["gf"]).apply(
    null,
    arguments
  );
});
var stackRestore = (Module["stackRestore"] = function () {
  return (stackRestore = Module["stackRestore"] = Module["asm"]["hf"]).apply(
    null,
    arguments
  );
});
var stackAlloc = (Module["stackAlloc"] = function () {
  return (stackAlloc = Module["stackAlloc"] = Module["asm"]["jf"]).apply(
    null,
    arguments
  );
});
var dynCall_ji = (Module["dynCall_ji"] = function () {
  return (dynCall_ji = Module["dynCall_ji"] = Module["asm"]["kf"]).apply(
    null,
    arguments
  );
});
var dynCall_iiij = (Module["dynCall_iiij"] = function () {
  return (dynCall_iiij = Module["dynCall_iiij"] = Module["asm"]["lf"]).apply(
    null,
    arguments
  );
});
var dynCall_viij = (Module["dynCall_viij"] = function () {
  return (dynCall_viij = Module["dynCall_viij"] = Module["asm"]["mf"]).apply(
    null,
    arguments
  );
});
var dynCall_iijii = (Module["dynCall_iijii"] = function () {
  return (dynCall_iijii = Module["dynCall_iijii"] = Module["asm"]["nf"]).apply(
    null,
    arguments
  );
});
var dynCall_jiji = (Module["dynCall_jiji"] = function () {
  return (dynCall_jiji = Module["dynCall_jiji"] = Module["asm"]["of"]).apply(
    null,
    arguments
  );
});
